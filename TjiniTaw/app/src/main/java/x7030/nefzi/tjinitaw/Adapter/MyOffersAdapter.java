...
public class MyOffersAdapter extends LoopingPagerAdapter<OffresModel> {
    ...
    public MyOffersAdapter(Context context, List<OffresModel> itemList, boolean isInfinite) {
    ...
    protected void bindView(View convertView, int listPosition, int viewType) {
        ...
        convertView.setOnClickListener(v -> {
            EventBus.getDefault().postSticky(new OffersItemClick(itemList.get(listPosition)));
        });
