...
import x7030nefzi.admin.Model.AdminModel;
...
public class Common {
    public static final String ADMIN_KEY = "User";
    public static final String PWD_KEY = "Password";
    public static final String USER_REFERENCESER = "Admin";
    public static final String SHIPPERS_REF = "Shippers";
    ...
    public static ShipperModel shipperSelected;
    public static OrderModel currentShippingOrder;
    public static AdminModel currentShipper;
