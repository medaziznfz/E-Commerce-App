                    ...
                    table_user.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if (dataSnapshot.child(edtPhone.getText().toString()).exists()) {
                                ...
                                Common.currentAdmin = dataSnapshot.child(edtPhone.getText().toString()).getValue(AdminModel.class);


                                if (Common.currentAdmin.getPassword().equals(edtPassword.getText().toString())) {

                                    if (ckbRemember.isChecked()) {
                                        Paper.book().write(Common.ADMIN_KEY, edtPhone.getText().toString());
